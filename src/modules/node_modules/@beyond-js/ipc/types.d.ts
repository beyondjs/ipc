...
declare namespace ns_0 {
  ...
  export type MessageType = 'ipc.request' | 'ipc.response' | 'ipc.event.route' | 'ipc.event.dispatch' | 'ipc.event.subscribe' | 'ipc.event.unsubscribe';
  /**
...
export import IHandler = ns_0.IHandler;
export import IListener = ns_0.IListener;
export import IEventSubscription = ns_0.IEventSubscription;
export import IEventRoute = ns_0.IEventRoute;
export import IEventDispatch = ns_0.IEventDispatch;
export import IRequestMessage = ns_0.IRequestMessage;
export import ErrorResponseType = ns_0.ErrorResponseType;
export import IResponseMessage = ns_0.IResponseMessage;
export import IProcessHandler = ns_0.IProcessHandler;
