...
declare namespace ns_0 {
  ...
  export type MessageType = 'ipc.request' | 'ipc.response' | 'ipc.event.emit' | 'ipc.event.dispatch' | 'ipc.event.subscribe' | 'ipc.event.unsubscribe';
  /**
...
export import IEventEmit = ns_0.IEventEmit;
export import IEventMessage = ns_0.IEventMessage;
