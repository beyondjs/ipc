...
import * as __beyond_dep_ns_1 from 'child_process';
import * as __beyond_dep_ns_2 from '@beyond-js/pending-promise/main';
// error.ts
...
declare namespace ns_1 {
  ...
  import ChildProcess = __beyond_dep_ns_1.ChildProcess;
  ...
  export class Dispatcher {
     ...
     */
    exec(target: string, action: string, ...params: any[]): PendingPromise<any>;
    destroy(): void;
  }
}
